...
my_query = cursor.query("""           
        SELECT id, track_ids, track_labels, track_bboxes, track_scores, 
        ...
        AS TRA(id, track_ids, track_labels, track_bboxes, track_scores) WHERE id = 1950 AND track_ids = [6] 
""")
...
print(response)
#print(type(response))
#response.to_csv('property.csv', index=False) 
