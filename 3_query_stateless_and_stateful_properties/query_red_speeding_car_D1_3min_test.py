...
# test: filter label = car in advance.
timestamp = time.time()
...
with open('./result/time_cost_D3_3min_' + readable_time, 'a') as file:
    ...
    # ======
    response.to_csv('./result/red_speeding_car_D1_3min.csv', index=False)
    # ======
